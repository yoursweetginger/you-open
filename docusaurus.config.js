...
const config = {
  title: 'You open',
  tagline: 'Метаинформация по известным ресурсам по странам',
  url: 'https://you-open.com/',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'you-open', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/ComradeAx0n/you-open/tree/master',
        },
        // blog: {
        //   id: 'events',
        //   path: './events',
